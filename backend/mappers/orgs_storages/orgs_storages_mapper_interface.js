export default class OrgsStoragesMapperInterface {
    constructor() {
        if (new.target === 'OrgsStoragesMapperInterface') {
            throw new Error('Нельзя создать экземпляр класса OrgsStoragesMapperInterface');
        }
    }
