export class BanksLoansBalanceMapperInterface {
    constructor() {
        if (new.target === 'BanksLoansBalanceMapperInterface') {
            throw new Error('Нельзя создать экземпляр класса BanksLoansBalanceMapperInterface');
        }
    }
