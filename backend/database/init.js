...
export async function initDatabase() {
  ...
  if (!hasIsResponse) {
    try {
      db.exec(`ALTER TABLE messages ADD COLUMN isResponse TINYINT(1) DEFAULT 0`);
    } catch (e) {
      console.error('Error adding fileType column:', e.message);
    }
  }
  ...
  if (!hasIsForward) {
    try {
      db.exec(`ALTER TABLE messages ADD COLUMN isForward TINYINT(1) DEFAULT 0`);
    } catch (e) {
      console.error('Error adding fileType column:', e.message);
    }
  }
  ...
  const defaultRangs = [
    { name: 'Рекрут', thumbnail_url: '/uploads/rangs/0.png', orderNumber: 0 },
    { name: 'Кандидат 1', thumbnail_url: '/uploads/rangs/1.png', orderNumber: 1 },
    { name: 'Кандидат 2', thumbnail_url: '/uploads/rangs/2.png', orderNumber: 2 },
    { name: 'Кандидат 3', thumbnail_url: '/uploads/rangs/3.png', orderNumber: 3 },
    { name: 'Кандидат 4', thumbnail_url: '/uploads/rangs/4.png', orderNumber: 4 },
    { name: 'Кандидат 5', thumbnail_url: '/uploads/rangs/5.png', orderNumber: 5 },
    { name: 'Младший Пост-Координатор', thumbnail_url: '/uploads/rangs/6.png', orderNumber: 6 },
    { name: 'Пост-Координатор', thumbnail_url: '/uploads/rangs/7.png', orderNumber: 7 },
    { name: 'Старший Пост-Координатор', thumbnail_url: '/uploads/rangs/8.png', orderNumber: 8 },
    { name: 'Пост-Мастер', thumbnail_url: '/uploads/rangs/9.png', orderNumber: 9 },
    { name: 'Старший Пост-мастер', thumbnail_url: '/uploads/rangs/10.png', orderNumber: 10 },
    { name: 'Младший Зам-Координатор', thumbnail_url: '/uploads/rangs/11.png', orderNumber: 11 },
    { name: 'Зам-Координатор', thumbnail_url: '/uploads/rangs/12.png', orderNumber: 12 },
    { name: 'Старший Зам-Координатор', thumbnail_url: '/uploads/rangs/13.png', orderNumber: 13 },
    ...
    { name: 'Ранг – Координатор-I', thumbnail_url: '/uploads/rangs/17.png', orderNumber: 17 },
    { name: 'Ранг – Координатор-II', thumbnail_url: '/uploads/rangs/18.png', orderNumber: 18 },
    { name: 'Ранг – Координатор-III', thumbnail_url: '/uploads/rangs/19.png', orderNumber: 19 },
    { name: 'Штаб - Координатор III ранга', thumbnail_url: '/uploads/rangs/20.png', orderNumber: 20 },
    { name: 'Штаб - Координатор II ранга', thumbnail_url: '/uploads/rangs/21.png', orderNumber: 21 },
    { name: 'Штаб - Координатор I ранга', thumbnail_url: '/uploads/rangs/22.png', orderNumber: 22 },
    { name: 'Арт - Координатор', thumbnail_url: '/uploads/rangs/23.png', orderNumber: 23 },
  ];
  ...
  const orgsSimpleItemsTableInfo = db.prepare("PRAGMA table_info(orgs_simple_items)").all();
  const hasOrgsSimpleItemsPrice = orgsSimpleItemsTableInfo.some(col => col.name === 'price');
  if (!hasOrgsSimpleItemsPrice) {
    try {
      db.exec(`ALTER TABLE orgs_simple_items ADD COLUMN price INTEGER DEFAULT 0`);
    } catch (e) {
      console.error('Error adding price to orgs_simple_items:', e.message);
    }
  }
