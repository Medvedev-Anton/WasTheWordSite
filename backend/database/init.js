...
export async function initDatabase() {
  ...
  const defaultRangs = [
    ...
    { name: 'Младший Старт-Координатор', thumbnail_url: '/uploads/rangs/6.png', orderNumber: 6 },
    { name: 'Старт-Координатор', thumbnail_url: '/uploads/rangs/7.png', orderNumber: 7 },
    { name: 'Старший Старт-Координатор', thumbnail_url: '/uploads/rangs/8.png', orderNumber: 8 },
    ...
    { name: 'Ранг – Координатор-I уровень', thumbnail_url: '/uploads/rangs/17.png', orderNumber: 17 },
    { name: 'Ранг – Координатор-II уровень', thumbnail_url: '/uploads/rangs/18.png', orderNumber: 18 },
    { name: 'Ранг – Координатор-III уровень', thumbnail_url: '/uploads/rangs/19.png', orderNumber: 19 },
