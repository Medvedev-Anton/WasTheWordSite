...
router.get('/:id', authenticateToken, (req, res) => {
  try {
    ...
    const user = db.prepare('SELECT id, username, email, firstName, lastName, age, work, about, avatar, role, isBanned, allowMessagesFrom, heroId, gender, balance, energy FROM users WHERE id = ?').get(userId);
